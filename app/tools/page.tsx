  ...
  return (
    <div className="mx-auto max-w-shell px-4 py-10 sm:px-6">
      <header className="max-w-measure-wide border-b border-rule pb-6">
        <h1 className="font-serif text-head-lg font-semibold text-ink">AI tools directory</h1>
        <p className="mt-3 font-serif text-dek text-muted">
          A reference to the tools that come up in our reporting — what each one does, who it
          suits, and what it costs.
        </p>
        <p className="meta mt-4 leading-relaxed">
          Entries are listed alphabetically within each section. We do not rank them, score them,
          or accept payment for inclusion. Where a link is a partner link, it is labelled as one
          on the entry itself.
        </p>
      </header>
      ...
      {categories.length === 0 ? (
        ...
        categories.map((category) => (
          <section key={category} className="border-t border-rule py-6 first:border-t-0">
